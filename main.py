...
BOT_TOKEN = os.environ.get("7900979981:AAF48mK6b58fOWRTEanpbJKVKBduIemkn3A", None) 
MONGO_URL = os.environ.get("MONGO_URL", None)
BOT_USERNAME = os.environ.get("StringFathe_rBot") 
UPDATE_CHNL = os.environ.get("https://t.me/u7eeh3hjo")
OWNER_ID = int(os.environ.get("5935882330"))
OWNER_USERNAME = os.environ.get("@ind_bgmi")
SUPPORT_GRP = os.environ.get("https://t.me/u7eeh3hjo")
BOT_NAME = os.environ.get("StringFathe_rBot")
